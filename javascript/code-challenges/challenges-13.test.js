...
const findHappiness = (arr) => {
  let newArr = [];
  arr.map(string => string.includes(':)')?newArr.push(string): '');
  return newArr;
};
...
Write a function named allHappy that takes in an array of strings and returns a Boolean indicating whether
all those strings contain ":)".
------------------------------------------------------------------------------------------------ */
