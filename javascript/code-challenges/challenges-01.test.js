...
------------------------------------------------------------------------------------------------ */
let stringyArray = ['first', 'second', 'third', 'fourth', 'fifth'];
let newStrArray = [];

const addExclamation = (stringyArray) => {
  stringyArray.forEach((i) => {
    newStrArray.push(i + '!');
  });
  return newStrArray;
};
...
------------------------------------------------------------------------------------------------ */
let newStrArray2 = [];
const allUpperCase = (stringyArray) => {
  stringyArray.forEach((i) => {
    newStrArray2.push(i.toUpperCase());
  });
  return newStrArray2;
};
...
const speaker = (stringyArray, callback) => {
  let arr = [];
  stringyArray.forEach((word) => {
